...
public class SimActualidadController {
    ...
    SimulacionActualidad s;
    boolean terminado = false;
    double tiempo;

    @FXML
    public void initialize() {
        s = new SimulacionActualidad();
        inicializarArrays();
                ...
                new KeyFrame(Duration.seconds(0.1), e -> {
                    ...
                    if(terminado){
                        ...
                        Platform.runLater(() -> {
                            ...
                            stage.setTitle("Resumen de Clientes y Cajas - Simulación SIN Fila Unica");
